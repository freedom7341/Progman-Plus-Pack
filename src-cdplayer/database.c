    ...
    )
{
    ...
    */
    ...
    wcscpy_s( ARTIST(cdrom), 256, IdStr(STR_UNKNOWN) ); // TODO: safe string functions
    ...
    */
    if ( _tcscmp(g_Devices[ cdrom ]->CdInfo.Title, g_szNothingThere) == 0 ) {
        ...
        */
        ...
        wcscat_s( lpPlayList, PLAYLEN, g_szBlank );
        porder = lpPlayList;
        prev = NULL;
